...
- `next_stage`: run a fresh weights-only 2-step smoke from complete `global_step_3500` with a reset optimizer, the deployed cumulative step offset, and corrected nested checkpoint audit, then resume ID training in `formal_10000_retry7`
