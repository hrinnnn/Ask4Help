...
- `source_commit`: `11bcf5c`; local branch `codex/xvla-fixed-grid-knee`; server worktree is detached at the same commit (Stage-B utility result and Stage-C handler retry recorded)
