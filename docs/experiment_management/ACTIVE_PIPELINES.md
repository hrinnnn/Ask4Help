...
- `current_stage`: `training_retry_v9_sdd_disk_safe` (v1 Ray socket; v2/v3 multi-GPU illegal-memory; v4 DCP-load; v5 controller-path; v6 step-offset; v7 disk-capacity; v8 smoke migration diagnostics)
...
- `controller`: v9 PID `1153921`; training PID `1153937`; checkpoint watcher PID `1820718`; repaired post-training controller PID `2124796`; state enricher PID `2133260`; last verified native additional step `1177/10000` at `2026-08-22T19:21+08:00`, cumulative `11177/20000`, loss `0.0239`, valid-action-ratio `0.982`, marker `TRAINING_IN_PROGRESS`, next stage `native_2500_checkpoint_audit`; first formal checkpoint expected at `/sdd/ask4help-open-drawer/results/open_drawer_pi05_resume_from10000_v9/training/pi05_weights_from10000_to20000/pi05_weights_from10000_to20000/checkpoints/global_step_2500`
...
- `parallel_gpu_probe`: 4-card diagnostic on GPU0/1/3/4 failed at model placement with `ENGINEERING_GPU_MAPPING_CONFLICT_OOM` because Ray mapped active v9 PID `1198612` into probe logical GPU0; probe exited and formal GPU2 was untouched. No 4-card long training will be started.
