...
- `source_commit`: `e30967d`; local branch `codex/xvla-fixed-grid-knee`; server worktree is detached at the same commit (diagnostic partial-evaluation gate recorded)
