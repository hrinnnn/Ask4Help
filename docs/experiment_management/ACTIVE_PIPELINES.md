...
- `source_commit`: `22ecff1`; local branch `codex/xvla-fixed-grid-knee`; server worktree is detached at the same commit (Stage-B utility, Stage-C passive result, and Diff-DAgger stop recorded)
