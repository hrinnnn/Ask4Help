...
- `source_commit`: `244a1ed`; fixed-timing collector and timing controllers are synced from the local GitHub branch; parallel helper is `6adbe09` and is synced to the server source tree
