...
- `source_commit`: `58e6187`; local branch `codex/xvla-fixed-grid-knee`; server worktree runs the code from `3d845cc` (behaviorally identical; the latest commit records the asset-repair provenance)
