...
- `source_commit`: `94a8397`; local branch `codex/xvla-fixed-grid-knee`; server worktree is detached at the same commit (Stage-B utility and Stage-C passive result recorded)
