...
# Protocol-v2 controller. It never starts until the repaired ID base and the
# ID-only detector/calibration gates have been explicitly materialized.
...
echo "$(date -Is) protocol_v2_controller_started" >> "$LOG"
