...
POLICY_ONLY_ROOT=${OPEN_DRAWER_TIMING_POLICY_ONLY_ROOT:-$ROOT/results/open_drawer_grasp_timing_sweep_v1_retry2/policy_only_grasp_ood}
GPU_POOL=${OPEN_DRAWER_TIMING_GPU_POOL:-"0 1 3 4 6 7"}
GPU_LOCK_ROOT=${OPEN_DRAWER_TIMING_GPU_LOCK_ROOT:-$RUN/.gpu_locks}
...
stop_and_replace_main() {
  ...
  env OPEN_DRAWER_ROOT="$ROOT" OPEN_DRAWER_PYTHON="$PY" \
    ...
    OPEN_DRAWER_TIMING_POLICY_ONLY_ROOT="$POLICY_ONLY_ROOT" OPEN_DRAWER_TIMING_GPU_POOL="$GPU_POOL" \
    OPEN_DRAWER_TIMING_GPU_LOCK_ROOT="$GPU_LOCK_ROOT" \
