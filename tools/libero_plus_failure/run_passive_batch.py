...
def execute(args: argparse.Namespace, schedule: list[dict[str, Any]], *, stop_after_successes: int | None) -> None:
...
def main() -> None:
    ...
    if args.mode == "calibration":
        ...
        execute(args, schedule, stop_after_successes=args.required_successes)
        return
