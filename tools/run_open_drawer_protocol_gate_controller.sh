...
# Gate controller for the corrected OpenDrawer protocol. It waits for the new
# ID base, validates Oracle coverage, rebuilds ID-only detector assets, and
...
ID_BASE_RUN=${OPEN_DRAWER_ID_BASE_RUN:-$ROOT/results/open_drawer_failure_detection_v1/id_base_protocol_v2_retry3}
...
STAGE_PID=$PID_DIR/protocol_v2_controller.pid
